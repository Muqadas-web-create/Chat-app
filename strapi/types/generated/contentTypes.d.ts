...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['blogs']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiCategoryNavigationCategoryNavigation
  extends Schema.CollectionType {
  collectionName: 'category_navigations';
  info: {
    singularName: 'category-navigation';
    pluralName: 'category-navigations';
  ...
  attributes: {
    categoryNavigation: Attribute.JSON & Attribute.Required;
    Items: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::category-navigation.category-navigation',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNewSubscriberNewSubscriber extends Schema.CollectionType {
  collectionName: 'new_subscribers';
  info: {
    singularName: 'new-subscriber';
    pluralName: 'new-subscribers';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::new-subscriber.new-subscriber',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiProductCategoryProductCategory
  ...
  attributes: {
    ...
    shop_id: Attribute.Integer & Attribute.Required;
    ...
    sku: Attribute.Integer & Attribute.Required;
    quantity: Attribute.Integer & Attribute.Required;
    in_stock: Attribute.Integer & Attribute.Required;
    is_taxable: Attribute.Integer & Attribute.Required;
    shipping_class_id: Attribute.String & Attribute.Required;
    status: Attribute.String & Attribute.Required;
    ...
    lenght: Attribute.String & Attribute.Required;
    image: Attribute.JSON & Attribute.Required;
...
export interface ApiProductListProductList extends Schema.CollectionType {
  ...
  attributes: {
    ...
    nextitems: Attribute.JSON;
    more: Attribute.JSON;
    add: Attribute.JSON;
    products: Attribute.JSON;
    star: Attribute.JSON;
    fruits: Attribute.JSON;
    grocery: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiReviewReview extends Schema.CollectionType {
  ...
  attributes: {
    ...
    reviewer: Attribute.Text;
    img: Attribute.Relation<'api::review.review', 'manyToOne', 'api::img.img'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSubmissionFormSubmissionForm extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Github: Attribute.Email & Attribute.Required;
    link: Attribute.UID;
    submitt: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSubscribersCollectionSubscribersCollection
  extends Schema.CollectionType {
  collectionName: 'subscribers_collections';
  info: {
    singularName: 'subscribers-collection';
    pluralName: 'subscribers-collections';
    displayName: 'Subscribers collection';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::subscribers-collection.subscribers-collection',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::category-navigation.category-navigation': ApiCategoryNavigationCategoryNavigation;
      'api::chat-room-message.chat-room-message': ApiChatRoomMessageChatRoomMessage;
      'api::img.img': ApiImgImg;
      'api::new-subscriber.new-subscriber': ApiNewSubscriberNewSubscriber;
      ...
      'api::subscribers-collection.subscribers-collection': ApiSubscribersCollectionSubscribersCollection;
    }
  }
}
